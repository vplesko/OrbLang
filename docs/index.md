...
From a technical standpoint, Orb can be thought of as a compiled, statically-typed, language with scope-based memory management and an intentionally limited core feature set.

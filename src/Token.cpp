...
const unordered_map<Token::Oper, OperInfo> operInfos = {
    {Token::O_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_ADD_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_SUB_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_MUL_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_DIV_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_REM_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_SHL_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_SHR_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_BIT_AND_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_BIT_XOR_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_BIT_OR_ASGN, {1, .l_assoc = false, .assignment=true}},
    {Token::O_OR, {2}},
    {Token::O_AND, {3}},
    {Token::O_BIT_OR, {4}},
    {Token::O_BIT_XOR, {5}},

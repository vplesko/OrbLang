...
const unordered_map<Token::Oper, OperInfo> operInfos = {
    ...
    {Token::O_EQ, {.comparison=true}},
    {Token::O_NEQ, {.variadic=false, .comparison=true}},
    {Token::O_LT, {.comparison=true}},
    {Token::O_LTEQ, {.comparison=true}},
    {Token::O_GT, {.comparison=true}},
    {Token::O_GTEQ, {.comparison=true}},
    {Token::O_SHL, {}},
    {Token::O_SHR, {}},
